...
# path = os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/mine/So05D_17.jpg")
# path = os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/pics/0018A_R_22_SA_line.tif")
path = os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/pics/0018A_R_22_SA_line.tif")
im = cv2.imread(path)
...
# cv2.imwrite(os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/mine/contour_") + path[-12:], im)
...
for c in cnts[5:]:
    ...
    print('Object size is: {} * {}'.format(dimB, dimA))
    for j in range(len(c)):
        n_contour = c[j]
        for d in range(len(n_contour)):
            XY_Coordinates = n_contour[d]
            with open(os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/data/results{}.txt".format(i)),
                      'a') as new_results:
                new_results.write(str(XY_Coordinates) + '\n')
    i += 1
    cv2.waitKey(0)
