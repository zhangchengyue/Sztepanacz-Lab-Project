...
# Whole wing
cv2.drawContours(im, cont, cont_index, (0, 0, 0), 6)
...
contours, hierarchies = cv2.findContours(threshold, cv2.RETR_LIST,
...
cv2.drawContours(im, contours, spot_cont_ind, (0, 0, 0), 6)
...
# with open(os.path.expanduser("~/St.George/2022Summer/WorkStudy/Project/mine/results.txt"), 'a') as new_results:
